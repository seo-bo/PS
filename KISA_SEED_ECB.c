/******************************************************************************** 
Created  June, 1999 * Modified  Dec, 2013 * FILE:         
KISA_SEED_ECB.c * * DESCRIPTION: Core routines for the enhanced SEED 
********************************************************************************/ 
/******************************* Include files *********************************/ 
...
void main()
{
	...
	BYTE pbUserKey[16] = {};
	BYTE pbData[16] = {};
	const char* KEY = "9F3879B964CB88490000000000000000";
	const char* PT = "00000000000000000000000000000000";
	const char* CT = "9B48304CAAAE2AB1C5303CAA47069C4D";
	/**********************************************
	KEY = 9F3879B964CB88490000000000000000
	PT = 00000000000000000000000000000000
	CT = 9B48304CAAAE2AB1C5303CAA47069C4D
	**********************************************/
	for (int i = 0; i < 16; ++i)
	{
		unsigned int temp, temp2;
		sscanf(&KEY[i * 2], "%02x", &temp2);
		sscanf(&PT[i * 2], "%02x", &temp);
		pbUserKey[i] = (BYTE)temp2;
		pbData[i] = (BYTE)temp;
	}
	int i = 0;
